...
and space. We leverage their reverse-engineering of Apple's \ac{CPS} request and
response formats to conduct our study.
...
We examine many of the questions, but applied to cellular infrastructure: how
might one remotely discover cellular \acp{BTS} around the world using Apple's
\ac{CPS}? Are there any security and privacy ramifications of providing free,
unlimited access to an API that provides such information? 
